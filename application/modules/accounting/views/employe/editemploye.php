    ...
    <div class="row">
      ...
      <input type="text" class="form-control" name='nama' required="" autocomplete="OFF" value="<?php echo $user->nama_lengkap?>" readonly=""/>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-md-6 col-xs-12">
<input type="text" class="form-control "  name='ttl' readonly="" value="<?php echo $user->tgl_lahir?>"/>
...
<textarea class="form-control" rows="5" name='alamat' readonly=""><?php echo $user->alm_tinggal?></textarea>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6 col-xs-12">
 <input type="number" name="phone" class="form-control" readonly="" value="<?php echo $user->no_hp?>">
                                                </div>
                                            </div>
                      <div class="form-group">
                          <label class="col-md-3 col-xs-12 control-label">Tanggal Bergabung</label>
                        <div class="col-md-6 col-xs-12">
<input type="text" class="form-control  "   name='join'  readonly="" value="<?php echo $user1->tgl_bergabung?>"/>
