  ...
  data-name="<?php echo $key->nama_lengkap?>" data-phone="<?php echo $key->no_hp?>" data-address="<?php echo $key->alm_tinggal?>" data-email="<?php echo $key->email?>"
    data-golongan="<?php echo $key->gol_jabatan?>"
                      ...
                      <div class="profile-controls">
                          <a href="<?php echo site_url('accounting/photo/'.$key->nip)?>" class="profile-control-left"><span class="fa fa-image"></span></a>
                          <a href="<?php echo site_url('accounting/editemploye/'.$key->nip)?>" class="profile-control-right"><span class="fa fa-edit"></span></a>
                      </div>
                  </div>
                  <div class="panel-body">
