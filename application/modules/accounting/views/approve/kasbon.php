...
<td colspan="" rowspan="" headers="">
  <?php if ($key->status_aju =="PENDING"): ?>
    <a href="#" class='btn btn-success' title="APPROVE">Approve  <i class="fa fa-check"></i></a>
    <a href="#" class='btn btn-danger' title="REJECT" >Reject<i class="fa fa-minus-square"></i></a>
