...
<?php foreach ($sum as $nom ): ?>
                                ...
                                <div class="panel-heading">
                                 <div class="col-md-4">
  <a href="<?php echo site_url('accounting/addkasbon/'.$this->session->userdata('nip'))?>"  <button class="btn btn-success btn-block"><span class="fa fa-plus"></span> Tambah Pinjaman</button></a>
                                    </div>
                                <?php endif;?>
