                ...
                <div class="mb-middle">
                    ...
                    <div class="mb-footer">
                        <div class="pull-right">
                            <a href="<?php echo base_url('employe/out')?>" class="btn btn-success btn-lg">YA</a>
...
tabelslip = $('#tblslipemp').DataTable({ 
        ...
        // Load data for the table's content from an Ajax source
        "ajax": {
            "url": "<?php echo site_url('ajax/slipemp/'.$this->uri->segment(3))?>",
            "type": "POST"
        },
