                        ...
                        <div class="col-md-12">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    ...
                                    <div class="col-md-4">
  <a href="<?php echo site_url('employe/ajucuti/').$this->session->userdata('nip')?>"  <button class="btn btn-success btn-block"><span class="fa fa-plus"></span> Ajukan Cuti</button></a>
                                    </div>
...
<?php if($key->status_cuti=="POSTING" || $key->status_cuti=="REJECT" || $key->status_cuti=="APPROVE" ):?>
    ...
    <?php else:?>
  <a class="btn btn-success fa fa-check-circle" title="" onClick=posting("<?php echo $key->id_cuti.'/'.$this->uri->segment(3).'/'.$lama.'/'.'POSTING'.'/'.$key->id?>")>Posting</a>  
<?php endif;?>
</td>
</tr>                                        
  <?php
