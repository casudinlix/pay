...
<!-- PAGE TITLE -->
 ...
 <a href="<?php echo site_url('hrd/addleave')?>"<button class="btn btn-success btn-block"><span class="fa fa-plus"></span> Add new leave</button></a>
...
<th>Awal Berlaku</th><th>Akhir Masa Berlaku</th><th>Terpakai</th><th>Sisa Cuti</th><th>Aksi</th>
              ...
              <td><a class="btn btn-info" href="<?php echo site_url('hrd/editleave/')?><?php echo $key->id_jc?>"><i class="fa fa-pencil"></i></a></td>
                                             </tr>
                                           <?php endforeach; ?>
