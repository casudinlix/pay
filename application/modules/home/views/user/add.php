...
<div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('aksi_1/adduser')?>" method="post" enctype="multipart/form-data">
    ...
    <input type="teks" name="code" class="form-control" required=""  />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="form-group">
