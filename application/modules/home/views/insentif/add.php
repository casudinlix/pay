...
<div class="page-content-wrap">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <form class="form-horizontal" action="<?php echo site_url('aksi_1/addinsentif')?>" method="post" enctype="multipart/form-data">
      ...
      <input type="text" name="code" class="form-control" required="" value="<?php echo $code?>" readonly=""/>
                                                    </div>
                                                 </div>
                                            </div>
<div class="form-group">
