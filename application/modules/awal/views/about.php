...
<script src="<?php echo tema();?>js/jquery-1.11.1.min.js"></script>
<script type="text/javascript" src="<?php echo tema();?>js/move-top.js"></script>
<script type="text/javascript" src="<?php echo tema();?>js/easing.js"></script>
<!--/web-font-->
		...
		<div class="main-textgrids">
				 		<div class="container">
				 			<div class="col-md-5 ab-pic">
				 					<img src="<?php echo tema();?>images/ab.jpg" alt=" " />
