...
class M_potongan extends CI_Model {
	var $table = 'gaji_potongan_view';
	var $column_order = array('id','id_gaji','nip','id_potongan','jenis_potongan','nominal_potongan','jml_potongan'); //set column field database for datatable orderable
	var $column_search = array('nip','id_gaji');
