...
class M_insentif extends CI_Model {
	var $table = 'gaji_insentif_view';
	var $column_order = array('id','id_gaji','nip','id_insentif','jenis_insentif','nominal_insentif','jml_insentif'); //set column field database for datatable orderable
