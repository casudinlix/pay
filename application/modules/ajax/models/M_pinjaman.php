...
class M_pinjaman extends CI_Model {
	var $table = 'pinjaman_view1';
	var $column_order = array('no_transaksi','nip','nama_lengkap','nominal_pinjaman','status_aju','status_pinjaman',); //set column field database for datatable orderable
	var $column_search = array('no_transaksi','nip');
