...
function img($uri = '',$thumb=false, $protocol = NULL)
	...
	function logo($uri = '',$thumb=false, $protocol = NULL)
		...
		function loder($uri = '',$thumb=false, $protocol = NULL)
			{
				$path="aset/img/loaders";
				if ($thumb==true){
					//$path.="-thumbs";
				}
				$path.="/";
	...
	function employe($uri = '',$thumb=false, $protocol = NULL)
		{
			$path="upload/";
			if ($thumb==true){
				//$path.="-thumbs";
		...
		function export($uri = '',$thumb=false, $protocol = NULL)
			{
				$path="aset/img/";
				if ($thumb==true){
					//$path.="-thumbs";
...
function logo1($uri = '',$thumb=false, $protocol = NULL)
	{
		$path="upload/";
		if ($thumb==true){
			$path.="logo";
